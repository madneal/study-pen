...
.method static synthetic a(Landroid/support/v7/widget/ak;)Landroid/support/v7/widget/af;
    ...
    iget-object p0, p0, Landroid/support/v7/widget/ak;->e:Landroid/support/v7/widget/af;
...
.method private a(Landroid/support/v7/a/a$c;Z)Landroid/support/v7/widget/ak$c;
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/widget/ak$c;->setBackgroundDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/widget/ak$c;->setLayoutParams(Landroid/view/ViewGroup$LayoutParams;)V
    ...
    invoke-virtual {v0, p2}, Landroid/support/v7/widget/ak$c;->setFocusable(Z)V

    iget-object p2, p0, Landroid/support/v7/widget/ak;->d:Landroid/support/v7/widget/ak$b;

    if-nez p2, :cond_1

    new-instance p2, Landroid/support/v7/widget/ak$b;

    invoke-direct {p2, p0, p1}, Landroid/support/v7/widget/ak$b;-><init>(Landroid/support/v7/widget/ak;Landroid/support/v7/widget/ak$1;)V

    iput-object p2, p0, Landroid/support/v7/widget/ak;->d:Landroid/support/v7/widget/ak$b;

    :cond_1
    iget-object p1, p0, Landroid/support/v7/widget/ak;->d:Landroid/support/v7/widget/ak$b;

    invoke-virtual {v0, p1}, Landroid/support/v7/widget/ak$c;->setOnClickListener(Landroid/view/View$OnClickListener;)V
...
.method private b()V
    ...
    invoke-direct {v2, p0, v1}, Landroid/support/v7/widget/ak$a;-><init>(Landroid/support/v7/widget/ak;Landroid/support/v7/widget/ak$1;)V
...
.method private c()Z
    ...
    invoke-virtual {p0, v0, v2}, Landroid/support/v7/widget/ak;->addView(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V
...
.method private d()Landroid/widget/Spinner;
    ...
    sget v2, Landroid/support/v7/b/a$a;->actionDropDownStyle:I
...
.method public a(I)V
    ...
    invoke-direct {v0, p0, p1}, Landroid/support/v7/widget/ak$1;-><init>(Landroid/support/v7/widget/ak;Landroid/view/View;)V

    iput-object v0, p0, Landroid/support/v7/widget/ak;->a:Ljava/lang/Runnable;

    iget-object p1, p0, Landroid/support/v7/widget/ak;->a:Ljava/lang/Runnable;

    invoke-virtual {p0, p1}, Landroid/support/v7/widget/ak;->post(Ljava/lang/Runnable;)Z
...
.method protected onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    invoke-virtual {p0, v0}, Landroid/support/v7/widget/ak;->setContentHeight(I)V
...
.method public onItemSelected(Landroid/widget/AdapterView;Landroid/view/View;IJ)V
    ...
    invoke-virtual {p1}, Landroid/support/v7/a/a$c;->d()V
...
.method public onMeasure(II)V
    ...
    :goto_0
    invoke-virtual {p0, v3}, Landroid/support/v7/widget/ak;->setFillViewport(Z)V
    ...
    :goto_1
    iget p2, p0, Landroid/support/v7/widget/ak;->b:I
    ...
    iget p2, p0, Landroid/support/v7/widget/ak;->h:I
    ...
    iget-boolean v2, p0, Landroid/support/v7/widget/ak;->g:Z
    ...
    invoke-virtual {v1, v0, p2}, Landroid/support/v7/widget/af;->measure(II)V
    ...
    iget p1, p0, Landroid/support/v7/widget/ak;->i:I

    invoke-virtual {p0, p1}, Landroid/support/v7/widget/ak;->setTabSelected(I)V
...
.method public setTabSelected(I)V
    ...
    iget-object v3, p0, Landroid/support/v7/widget/ak;->e:Landroid/support/v7/widget/af;
