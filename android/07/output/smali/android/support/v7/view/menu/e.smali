...
.method public constructor <init>(Landroid/content/Context;I)V
    ...
    iput-object p1, p0, Landroid/support/v7/view/menu/e;->b:Landroid/view/LayoutInflater;
...
.method static synthetic a(Landroid/support/v7/view/menu/e;)I
    ...
    iget p0, p0, Landroid/support/v7/view/menu/e;->h:I
...
.method public a(Landroid/view/ViewGroup;)Landroid/support/v7/view/menu/m;
    ...
    iput-object p1, p0, Landroid/support/v7/view/menu/e;->d:Landroid/support/v7/view/menu/ExpandedMenuView;

    iget-object p1, p0, Landroid/support/v7/view/menu/e;->g:Landroid/support/v7/view/menu/e$a;

    if-nez p1, :cond_0

    new-instance p1, Landroid/support/v7/view/menu/e$a;

    invoke-direct {p1, p0}, Landroid/support/v7/view/menu/e$a;-><init>(Landroid/support/v7/view/menu/e;)V

    iput-object p1, p0, Landroid/support/v7/view/menu/e;->g:Landroid/support/v7/view/menu/e$a;

    :cond_0
    iget-object p1, p0, Landroid/support/v7/view/menu/e;->d:Landroid/support/v7/view/menu/ExpandedMenuView;
...
.method public a(Landroid/content/Context;Landroid/support/v7/view/menu/f;)V
    ...
    iget-object p1, p0, Landroid/support/v7/view/menu/e;->b:Landroid/view/LayoutInflater;
    ...
    invoke-virtual {p1}, Landroid/support/v7/view/menu/e$a;->notifyDataSetChanged()V
...
.method public onItemClick(Landroid/widget/AdapterView;Landroid/view/View;IJ)V
    ...
    iget-object p1, p0, Landroid/support/v7/view/menu/e;->c:Landroid/support/v7/view/menu/f;

    iget-object p2, p0, Landroid/support/v7/view/menu/e;->g:Landroid/support/v7/view/menu/e$a;

    invoke-virtual {p2, p3}, Landroid/support/v7/view/menu/e$a;->a(I)Landroid/support/v7/view/menu/h;

    move-result-object p2

    const/4 p3, 0x0

    invoke-virtual {p1, p2, p0, p3}, Landroid/support/v7/view/menu/f;->a(Landroid/view/MenuItem;Landroid/support/v7/view/menu/l;I)Z
