...
.method public static a(Ljava/lang/Object;Landroid/view/View;Ljava/util/ArrayList;Ljava/util/Map;Landroid/view/View;)Ljava/lang/Object;
    ...
    invoke-static {p2, p1}, Landroid/support/v4/a/u;->b(Ljava/util/ArrayList;Landroid/view/View;)V
    ...
    invoke-static {p1, p2}, Landroid/support/v4/a/u;->b(Ljava/lang/Object;Ljava/util/ArrayList;)V
...
.method private static a(Landroid/transition/Transition;Landroid/support/v4/a/u$a;)V
    .locals 1
    ...
    invoke-direct {v0, p1}, Landroid/support/v4/a/u$3;-><init>(Landroid/support/v4/a/u$a;)V
...
.method public static a(Landroid/view/View;Landroid/view/View;Ljava/lang/Object;Ljava/util/ArrayList;Ljava/lang/Object;Ljava/util/ArrayList;Ljava/lang/Object;Ljava/util/ArrayList;Ljava/lang/Object;Ljava/util/ArrayList;Ljava/util/Map;)V
    ...
    new-instance v13, Landroid/support/v4/a/u$4;
...
.method public static a(Ljava/lang/Object;Landroid/view/View;)V
    ...
    invoke-static {p1}, Landroid/support/v4/a/u;->c(Landroid/view/View;)Landroid/graphics/Rect;

    move-result-object p1

    new-instance v0, Landroid/support/v4/a/u$1;

    invoke-direct {v0, p1}, Landroid/support/v4/a/u$1;-><init>(Landroid/graphics/Rect;)V
...
.method public static a(Ljava/lang/Object;Landroid/view/View;Ljava/util/Map;Ljava/util/ArrayList;)V
    ...
    invoke-static {p2, v2}, Landroid/support/v4/a/u;->a(Ljava/util/List;Landroid/view/View;)V
    ...
    invoke-static {p0, p3}, Landroid/support/v4/a/u;->b(Ljava/lang/Object;Ljava/util/ArrayList;)V
...
.method public static a(Ljava/lang/Object;Ljava/lang/Object;Landroid/view/View;Landroid/support/v4/a/u$b;Landroid/view/View;Landroid/support/v4/a/u$a;Ljava/util/Map;Ljava/util/ArrayList;Ljava/util/Map;Ljava/util/Map;Ljava/util/ArrayList;)V
    .locals 11
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {v1, v3, v0, v2}, Landroid/support/v4/a/u;->a(Ljava/lang/Object;Landroid/view/View;Ljava/util/Map;Ljava/util/ArrayList;)V
    ...
    new-instance v10, Landroid/support/v4/a/u$2;
    ...
    invoke-direct/range {v0 .. v7}, Landroid/support/v4/a/u$2;-><init>(Landroid/view/View;Landroid/transition/Transition;Landroid/view/View;Landroid/support/v4/a/u$b;Ljava/util/Map;Ljava/util/Map;Ljava/util/ArrayList;)V
    ...
    invoke-static {v8, v0}, Landroid/support/v4/a/u;->a(Landroid/transition/Transition;Landroid/support/v4/a/u$a;)V
...
.method public static a(Ljava/lang/Object;Ljava/util/ArrayList;)V
    ...
    invoke-static {v2, p1}, Landroid/support/v4/a/u;->a(Ljava/lang/Object;Ljava/util/ArrayList;)V
    ...
    :cond_0
    invoke-static {p0}, Landroid/support/v4/a/u;->a(Landroid/transition/Transition;)Z
...
.method static synthetic a(Ljava/util/ArrayList;Landroid/view/View;)V
    ...
    invoke-static {p0, p1}, Landroid/support/v4/a/u;->b(Ljava/util/ArrayList;Landroid/view/View;)V
...
.method private static a(Ljava/util/List;Landroid/view/View;)V
    ...
    invoke-static {p0, p1, v0}, Landroid/support/v4/a/u;->a(Ljava/util/List;Landroid/view/View;I)Z
    ...
    invoke-static {p0, v4, v0}, Landroid/support/v4/a/u;->a(Ljava/util/List;Landroid/view/View;I)Z
...
.method public static a(Ljava/util/Map;Landroid/view/View;)V
    ...
    invoke-static {p0, v2}, Landroid/support/v4/a/u;->a(Ljava/util/Map;Landroid/view/View;)V
...
.method private static a(Landroid/transition/Transition;)Z
    ...
    invoke-static {v0}, Landroid/support/v4/a/u;->a(Ljava/util/List;)Z
    ...
    invoke-static {p0}, Landroid/support/v4/a/u;->a(Ljava/util/List;)Z
...
.method static synthetic b(Landroid/view/View;)Landroid/graphics/Rect;
    ...
    invoke-static {p0}, Landroid/support/v4/a/u;->c(Landroid/view/View;)Landroid/graphics/Rect;
...
.method public static b(Ljava/lang/Object;Ljava/util/ArrayList;)V
    ...
    invoke-static {v2, p1}, Landroid/support/v4/a/u;->b(Ljava/lang/Object;Ljava/util/ArrayList;)V
...
.method private static b(Ljava/util/ArrayList;Landroid/view/View;)V
    ...
    invoke-static {p0, v2}, Landroid/support/v4/a/u;->b(Ljava/util/ArrayList;Landroid/view/View;)V
