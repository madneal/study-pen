...
# static fields
.field private static final a:Landroid/support/v4/a/ac$b;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0}, Landroid/support/v4/a/ac$d;-><init>()V

    :goto_0
    sput-object v0, Landroid/support/v4/a/ac;->a:Landroid/support/v4/a/ac$b;
...
.method public a(Landroid/app/Activity;)Landroid/support/v4/a/ac;
    ...
    instance-of v0, p1, Landroid/support/v4/a/ac$a;
    ...
    invoke-interface {v0}, Landroid/support/v4/a/ac$a;->a()Landroid/content/Intent;
    ...
    iget-object p1, p0, Landroid/support/v4/a/ac;->c:Landroid/content/Context;
    ...
    :cond_2
    invoke-virtual {p0, p1}, Landroid/support/v4/a/ac;->a(Landroid/content/ComponentName;)Landroid/support/v4/a/ac;

    invoke-virtual {p0, v0}, Landroid/support/v4/a/ac;->a(Landroid/content/Intent;)Landroid/support/v4/a/ac;
...
.method public a(Landroid/content/ComponentName;)Landroid/support/v4/a/ac;
    ...
    :goto_0
    invoke-static {v1, p1}, Landroid/support/v4/a/x;->a(Landroid/content/Context;Landroid/content/ComponentName;)Landroid/content/Intent;
