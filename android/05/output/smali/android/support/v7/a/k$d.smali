...
.method constructor <init>(I)V
    ...
    iput-boolean p1, p0, Landroid/support/v7/a/k$d;->q:Z
...
.method a(Landroid/support/v7/view/menu/l$a;)Landroid/support/v7/view/menu/m;
    ...
    iget-object p1, p0, Landroid/support/v7/a/k$d;->j:Landroid/support/v7/view/menu/f;
    ...
    :cond_1
    iget-object p1, p0, Landroid/support/v7/a/k$d;->k:Landroid/support/v7/view/menu/e;

    iget-object v0, p0, Landroid/support/v7/a/k$d;->g:Landroid/view/ViewGroup;

    invoke-virtual {p1, v0}, Landroid/support/v7/view/menu/e;->a(Landroid/view/ViewGroup;)Landroid/support/v7/view/menu/m;
...
.method a(Landroid/content/Context;)V
    ...
    sget-object p1, Landroid/support/v7/b/a$k;->AppCompatTheme:[I

    invoke-virtual {v0, p1}, Landroid/content/Context;->obtainStyledAttributes([I)Landroid/content/res/TypedArray;

    move-result-object p1

    sget v0, Landroid/support/v7/b/a$k;->AppCompatTheme_panelBackground:I

    invoke-virtual {p1, v0, v2}, Landroid/content/res/TypedArray;->getResourceId(II)I

    move-result v0

    iput v0, p0, Landroid/support/v7/a/k$d;->b:I

    sget v0, Landroid/support/v7/b/a$k;->AppCompatTheme_android_windowAnimationStyle:I

    invoke-virtual {p1, v0, v2}, Landroid/content/res/TypedArray;->getResourceId(II)I

    move-result v0

    iput v0, p0, Landroid/support/v7/a/k$d;->f:I
...
.method public a()Z
    ...
    iget-object v0, p0, Landroid/support/v7/a/k$d;->h:Landroid/view/View;
    ...
    :cond_0
    iget-object v0, p0, Landroid/support/v7/a/k$d;->i:Landroid/view/View;
