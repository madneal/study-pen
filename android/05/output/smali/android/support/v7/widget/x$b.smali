...
.method public constructor <init>(Landroid/support/v7/widget/x;Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object p2, p0, Landroid/support/v7/widget/x$b;->e:Landroid/graphics/Rect;
...
.method static synthetic a(Landroid/support/v7/widget/x$b;)Landroid/widget/ListAdapter;
    ...
    iget-object p0, p0, Landroid/support/v7/widget/x$b;->d:Landroid/widget/ListAdapter;
...
.method private b(Landroid/view/View;)Z
    ...
    invoke-static {p1}, Landroid/support/v4/h/af;->r(Landroid/view/View;)Z
...
.method b()V
    ...
    iget-object v3, p0, Landroid/support/v7/widget/x$b;->a:Landroid/support/v7/widget/x;

    invoke-virtual {v3}, Landroid/support/v7/widget/x;->getWidth()I

    move-result v3

    iget-object v4, p0, Landroid/support/v7/widget/x$b;->a:Landroid/support/v7/widget/x;
    ...
    iget-object v5, p0, Landroid/support/v7/widget/x$b;->d:Landroid/widget/ListAdapter;
    ...
    invoke-static {v4, v5, v6}, Landroid/support/v7/widget/x;->a(Landroid/support/v7/widget/x;Landroid/widget/SpinnerAdapter;Landroid/graphics/drawable/Drawable;)I

    move-result v4

    iget-object v5, p0, Landroid/support/v7/widget/x$b;->a:Landroid/support/v7/widget/x;
    ...
    :goto_2
    invoke-virtual {p0, v4}, Landroid/support/v7/widget/x$b;->f(I)V
    ...
    invoke-static {v4}, Landroid/support/v7/widget/au;->a(Landroid/view/View;)Z
    ...
    :goto_4
    invoke-virtual {p0, v1}, Landroid/support/v7/widget/x$b;->b(I)V
