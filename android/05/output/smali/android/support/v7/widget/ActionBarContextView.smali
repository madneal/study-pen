...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    sget p2, Landroid/support/v7/b/a$k;->ActionMode_background:I
    ...
    sget p2, Landroid/support/v7/b/a$k;->ActionMode_titleTextStyle:I
    ...
    sget p2, Landroid/support/v7/b/a$k;->ActionMode_subtitleTextStyle:I
    ...
    sget p2, Landroid/support/v7/b/a$k;->ActionMode_height:I

    invoke-virtual {p1, p2, v1}, Landroid/support/v7/widget/ar;->f(II)I

    move-result p2

    iput p2, p0, Landroid/support/v7/widget/ActionBarContextView;->e:I

    sget p2, Landroid/support/v7/b/a$k;->ActionMode_closeItemLayout:I

    sget p3, Landroid/support/v7/b/a$h;->abc_action_mode_close_item_material:I

    invoke-virtual {p1, p2, p3}, Landroid/support/v7/widget/ar;->g(II)I
...
.method private e()V
    ...
    sget v1, Landroid/support/v7/b/a$h;->abc_action_bar_title_item:I
    ...
    sget v1, Landroid/support/v7/b/a$f;->action_bar_title:I
    ...
    sget v1, Landroid/support/v7/b/a$f;->action_bar_subtitle:I
...
.method public a(Landroid/support/v7/view/b;)V
    ...
    invoke-virtual {p1, v1, v2}, Landroid/support/v7/view/menu/f;->a(Landroid/support/v7/view/menu/l;Landroid/content/Context;)V

    iget-object p1, p0, Landroid/support/v7/widget/ActionBarContextView;->d:Landroid/support/v7/widget/d;

    invoke-virtual {p1, p0}, Landroid/support/v7/widget/d;->a(Landroid/view/ViewGroup;)Landroid/support/v7/view/menu/m;
