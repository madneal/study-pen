...
.method static constructor <clinit>()V
    ...
    sget v3, Landroid/support/v7/b/a$e;->abc_textfield_search_default_mtrl_alpha:I

    const/4 v4, 0x0

    aput v3, v2, v4

    sget v3, Landroid/support/v7/b/a$e;->abc_textfield_default_mtrl_alpha:I

    const/4 v5, 0x1

    aput v3, v2, v5

    sget v3, Landroid/support/v7/b/a$e;->abc_ab_share_pack_mtrl_alpha:I
    ...
    sget v3, Landroid/support/v7/b/a$e;->abc_ic_ab_back_mtrl_am_alpha:I

    aput v3, v2, v4

    sget v3, Landroid/support/v7/b/a$e;->abc_ic_go_search_api_mtrl_alpha:I

    aput v3, v2, v5

    sget v3, Landroid/support/v7/b/a$e;->abc_ic_search_api_mtrl_alpha:I

    aput v3, v2, v6

    sget v3, Landroid/support/v7/b/a$e;->abc_ic_commit_search_api_mtrl_alpha:I

    aput v3, v2, v0

    sget v3, Landroid/support/v7/b/a$e;->abc_ic_clear_mtrl_alpha:I

    const/4 v7, 0x4

    aput v3, v2, v7

    sget v3, Landroid/support/v7/b/a$e;->abc_ic_menu_share_mtrl_alpha:I

    const/4 v8, 0x5

    aput v3, v2, v8

    sget v3, Landroid/support/v7/b/a$e;->abc_ic_menu_copy_mtrl_am_alpha:I

    aput v3, v2, v1

    sget v3, Landroid/support/v7/b/a$e;->abc_ic_menu_cut_mtrl_alpha:I

    const/4 v9, 0x7

    aput v3, v2, v9

    sget v3, Landroid/support/v7/b/a$e;->abc_ic_menu_selectall_mtrl_alpha:I

    const/16 v10, 0x8

    aput v3, v2, v10

    sget v3, Landroid/support/v7/b/a$e;->abc_ic_menu_paste_mtrl_am_alpha:I

    const/16 v11, 0x9

    aput v3, v2, v11

    sget v3, Landroid/support/v7/b/a$e;->abc_ic_menu_moreoverflow_mtrl_alpha:I

    const/16 v12, 0xa

    aput v3, v2, v12

    sget v3, Landroid/support/v7/b/a$e;->abc_ic_voice_search_api_mtrl_alpha:I

    const/16 v13, 0xb

    aput v3, v2, v13

    sput-object v2, Landroid/support/v7/widget/l;->e:[I

    new-array v2, v7, [I

    sget v3, Landroid/support/v7/b/a$e;->abc_textfield_activated_mtrl_alpha:I

    aput v3, v2, v4

    sget v3, Landroid/support/v7/b/a$e;->abc_textfield_search_activated_mtrl_alpha:I

    aput v3, v2, v5

    sget v3, Landroid/support/v7/b/a$e;->abc_cab_background_top_mtrl_alpha:I

    aput v3, v2, v6

    sget v3, Landroid/support/v7/b/a$e;->abc_text_cursor_material:I

    aput v3, v2, v0

    sput-object v2, Landroid/support/v7/widget/l;->f:[I

    new-array v2, v0, [I

    sget v3, Landroid/support/v7/b/a$e;->abc_popup_background_mtrl_mult:I

    aput v3, v2, v4

    sget v3, Landroid/support/v7/b/a$e;->abc_cab_background_internal_bg:I

    aput v3, v2, v5

    sget v3, Landroid/support/v7/b/a$e;->abc_menu_hardkey_panel_mtrl_mult:I

    aput v3, v2, v6

    sput-object v2, Landroid/support/v7/widget/l;->g:[I

    new-array v2, v12, [I

    sget v3, Landroid/support/v7/b/a$e;->abc_edit_text_material:I

    aput v3, v2, v4

    sget v3, Landroid/support/v7/b/a$e;->abc_tab_indicator_material:I

    aput v3, v2, v5

    sget v3, Landroid/support/v7/b/a$e;->abc_textfield_search_material:I

    aput v3, v2, v6

    sget v3, Landroid/support/v7/b/a$e;->abc_spinner_mtrl_am_alpha:I

    aput v3, v2, v0

    sget v0, Landroid/support/v7/b/a$e;->abc_spinner_textfield_background_material:I

    aput v0, v2, v7

    sget v0, Landroid/support/v7/b/a$e;->abc_ratingbar_full_material:I

    aput v0, v2, v8

    sget v0, Landroid/support/v7/b/a$e;->abc_switch_track_mtrl_alpha:I

    aput v0, v2, v1

    sget v0, Landroid/support/v7/b/a$e;->abc_switch_thumb_material:I

    aput v0, v2, v9

    sget v0, Landroid/support/v7/b/a$e;->abc_btn_default_mtrl_shape:I

    aput v0, v2, v10

    sget v0, Landroid/support/v7/b/a$e;->abc_btn_borderless_material:I

    aput v0, v2, v11

    sput-object v2, Landroid/support/v7/widget/l;->h:[I
...
.method private a(Landroid/content/Context;)Landroid/content/res/ColorStateList;
    ...
    sget-object p1, Landroid/support/v7/widget/am;->b:[I
    ...
    sget-object p1, Landroid/support/v7/widget/am;->c:[I
    ...
    sget-object p1, Landroid/support/v7/widget/am;->d:[I
    ...
    sget-object p1, Landroid/support/v7/widget/am;->e:[I
    ...
    sget-object p1, Landroid/support/v7/widget/am;->f:[I
    ...
    sget-object p1, Landroid/support/v7/widget/am;->h:[I
...
.method private a(Landroid/content/Context;IZLandroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    sget p3, Landroid/support/v7/b/a$a;->colorControlActivated:I

    invoke-static {p1, p3}, Landroid/support/v7/widget/am;->a(Landroid/content/Context;I)I
    ...
    invoke-static {p1, v0}, Landroid/support/v7/widget/am;->c(Landroid/content/Context;I)I
...
.method private a(Landroid/content/Context;J)Landroid/graphics/drawable/Drawable;
    ...
    :cond_0
    invoke-virtual {v1, p2, p3}, Landroid/support/v4/g/e;->a(J)Ljava/lang/Object;
    ...
    :cond_1
    invoke-virtual {v1, p2, p3}, Landroid/support/v4/g/e;->b(J)V
...
.method public static a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/ap;[I)V
    ...
    iget-object p1, p1, Landroid/support/v7/widget/ap;->b:Landroid/graphics/PorterDuff$Mode;
...
.method static a(Landroid/content/Context;ILandroid/graphics/drawable/Drawable;)Z
    ...
    sget p1, Landroid/support/v7/b/a$a;->colorControlNormal:I
    ...
    sget p1, Landroid/support/v7/b/a$a;->colorControlActivated:I
    ...
    :cond_2
    sget v1, Landroid/support/v7/b/a$e;->abc_list_divider_mtrl_alpha:I
    ...
    :cond_4
    invoke-static {p0, v0}, Landroid/support/v7/widget/am;->a(Landroid/content/Context;I)I

    move-result p0

    invoke-static {p0, v1}, Landroid/support/v7/widget/l;->a(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
...
.method private a(Landroid/content/Context;JLandroid/graphics/drawable/Drawable;)Z
    ...
    invoke-direct {v1}, Landroid/support/v4/g/e;-><init>()V
    ...
    invoke-virtual {v1, p2, p3, p1}, Landroid/support/v4/g/e;->b(JLjava/lang/Object;)V
...
.method private c(Landroid/content/Context;)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p1, v2, v4}, Landroid/support/v7/widget/am;->a(Landroid/content/Context;IF)I
    ...
    invoke-static {p1, v3, v5}, Landroid/support/v7/widget/am;->a(Landroid/content/Context;IF)I
    ...
    invoke-static {p1, v2, v5}, Landroid/support/v7/widget/am;->a(Landroid/content/Context;IF)I
...
.method private c(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    :cond_1
    sget v5, Landroid/support/v7/b/a$e;->abc_cab_background_top_material:I
...
.method private d(Landroid/content/Context;)Landroid/content/res/ColorStateList;
    ...
    sget-object v6, Landroid/support/v7/widget/am;->a:[I
    ...
    sget v5, Landroid/support/v7/b/a$a;->colorControlActivated:I

    invoke-static {p1, v5}, Landroid/support/v7/widget/am;->a(Landroid/content/Context;I)I
...
.method private d(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    iget-object p1, p0, Landroid/support/v7/widget/l;->l:Landroid/util/SparseArray;
...
.method private f(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    sget v3, Landroid/support/v7/b/a$a;->colorButtonNormal:I
